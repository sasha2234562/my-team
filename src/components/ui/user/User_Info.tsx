    ...
    return (
        <div className={u.textContent}>
            <div className={u.text}>
                ...
                Не менее важно уделять внимание обмену знаниями: "Один из самых позитивных моментов — это осознание
                того,
            ...
            <div className={u.contact}>
                <div>
                    <Icon IconId={'phone'} width={'24'} height={'24'} viewBox={'0 0 24 24'}/>
                    <span>+7 (954) 333-44-55</span>
                </div>
                <div>
                    <Icon IconId={'mail'} width={'24'} height={'24'} viewBox={'0 0 24 24'}/>
                    <span>skalitsenia@inbox.ru</span>
                </div>
            </div>
        </div>
    );
